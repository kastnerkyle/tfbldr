...
for offset in [16, 44, 308, 421, 517, 752, 866]:
    ...
    if not os.path.exists("samples"):
        os.mkdir("samples")
    save_image_array(x_ts, "samples/multichannel_pixel_cnn_markov1_chords_gen_{}_seed_{}_temp_{}.png".format(offset, args.seed, args.temp))
    ...
    quantized_to_pretty_midi([decoded_satb_midi],
                             0.25,
                             save_dir="samples",
                             name_tag="multichannel_markov1_chords_sample_{}_seed_{}_temp_{}".format(offset, args.seed, args.temp) + "_{}.mid",
